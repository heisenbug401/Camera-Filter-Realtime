...
import com.lookie.camerafilterrealtime.filter.AsciiArtFilter;
import com.lookie.camerafilterrealtime.filter.BasicDeformFilter;
import com.lookie.camerafilterrealtime.filter.BlackAndWhiteFilter;
import com.lookie.camerafilterrealtime.filter.BlueorangeFilter;
import com.lookie.camerafilterrealtime.filter.CameraFilter;
import com.lookie.camerafilterrealtime.filter.CartoonFilter;
import com.lookie.camerafilterrealtime.filter.CastingFilter;
import com.lookie.camerafilterrealtime.filter.ChromaticAberrationFilter;
import com.lookie.camerafilterrealtime.filter.ContrastFilter;
import com.lookie.camerafilterrealtime.filter.CrackedFilter;
import com.lookie.camerafilterrealtime.filter.CrosshatchFilter;
import com.lookie.camerafilterrealtime.filter.EMInterferenceFilter;
import com.lookie.camerafilterrealtime.filter.EdgeDetectionFilter;
import com.lookie.camerafilterrealtime.filter.GrayFilter;
import com.lookie.camerafilterrealtime.filter.HexagonMosaicFilter;
import com.lookie.camerafilterrealtime.filter.JFAVoronoiFilter;
import com.lookie.camerafilterrealtime.filter.LegofiedFilter;
import com.lookie.camerafilterrealtime.filter.LichtensteinEsqueFilter;
import com.lookie.camerafilterrealtime.filter.MappingFilter;
import com.lookie.camerafilterrealtime.filter.MirrorFilter;
import com.lookie.camerafilterrealtime.filter.MoneyFilter;
import com.lookie.camerafilterrealtime.filter.NegativeFilter;
import com.lookie.camerafilterrealtime.filter.NoiseWarpFilter;
import com.lookie.camerafilterrealtime.filter.NostalgiaFilter;
import com.lookie.camerafilterrealtime.filter.OriginalFilter;
import com.lookie.camerafilterrealtime.filter.PixelizeFilter;
import com.lookie.camerafilterrealtime.filter.PolygonizationFilter;
import com.lookie.camerafilterrealtime.filter.RefractionFilter;
import com.lookie.camerafilterrealtime.filter.ReliefFilter;
import com.lookie.camerafilterrealtime.filter.SwirlFilter;
import com.lookie.camerafilterrealtime.filter.TileMosaicFilter;
import com.lookie.camerafilterrealtime.filter.TrianglesMosaicFilter;
import com.lookie.camerafilterrealtime.filter.TripleFilter;
import com.lookie.camerafilterrealtime.filter.WaterReflectionFilter;
